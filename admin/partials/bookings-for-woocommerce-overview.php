...
<div class="wps-overview__wrapper">
	...
	<div class="wps-overview__content">
		<div class="wps-overview__content-description">
			<h2><?php esc_html_e( 'What is WPS Bookings for WooCommerce?', 'mwb-bookings-for-woocommerce' ); ?></h2>
			<p>
				<?php
				esc_html_e(
		...
		<div class="wps-overview__keywords">
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Adaptable Bookings', 'mwb-bookings-for-woocommerce' ); ?></h3>
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Availability Settings to Offer Bookings', 'mwb-bookings-for-woocommerce' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Ease of Setting a Booking Calendar', 'mwb-bookings-for-woocommerce' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Subtly Stress Additional Costs On Demand Surge', 'mwb-bookings-for-woocommerce' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Set-Forth Booking Limits For Day', 'mwb-bookings-for-woocommerce' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
			...
			<div class="wps-overview__keywords-item">
				<div class="wps-overview__keywords-card">
					...
					<div class="wps-overview__keywords-text">
						<h3 class="wps-overview__keywords-heading"><?php esc_html_e( 'Easy Booking Cancellation', 'mwb-bookings-for-woocommerce' ); ?></h3>
						<p class="wps-overview__keywords-description">
							<?php
							esc_html_e(
