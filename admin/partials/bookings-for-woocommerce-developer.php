...
$bfw_developer_admin_hooks = 
//desc - Admin Hooks listing.
apply_filters('bfw_developer_admin_hooks_array', array());
$count_admin                 = filtered_array($bfw_developer_admin_hooks);
$bfw_developer_public_hooks = 
//desc - Public Hooks listing.
apply_filters('bfw_developer_public_hooks_array', array());
$count_public = filtered_array($bfw_developer_public_hooks);
?>
 ...
 * Filter hooks.
 *
 * @param array $argu array containing arguments.
 * @return array
 */
