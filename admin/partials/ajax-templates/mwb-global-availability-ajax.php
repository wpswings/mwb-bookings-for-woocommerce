...
<div id="mwb_global_availability_rule_<?php echo esc_html( $rule_count ); ?>"  data-id="<?php echo esc_html( $rule_count ); ?>" class="mwb-availability-rules__table">
	...
	<button type="button" id="mwb_delete_avialability_rule" class="button mwb-delete-icon ajax-added" rule_count="<?php echo esc_html( $rule_count ); ?>" title="<?php esc_attr_e( 'Delete Rule', 'mwb-wc-bk' ); ?>" >
