...
// 		'wps_bfw_booking_cost'                      => '',
// 		'wps_bfw_is_booking_cost_multiply_people'   => '',
// 		'wps_bfw_is_booking_cost_multiply_duration' => '',
// 		'wps_bfw_service_cost'                      => '',
// 		'wps_bfw_is_service_cost_multiply_people'   => '',
// 		'wps_bfw_is_service_cost_multiply_duration' => '',
// 		'wps_bfw_is_service_optional' 				 => '',
// 		'wps_bfw_is_service_hidden'                 => '',
// 		'wps_bfw_is_service_has_quantity'           => '',
// 		'wps_bfw_service_minimum_quantity'		    => '',
// 		'wps_bfw_service_maximum_quantity'          => '',
// 	);
// 	foreach ( $wps_booking_old_term_meta_keys as $key => $meta_keys ) {

// 		$term_args_cost = array( 
// 			'taxonomy' => 'wps_booking_cost',
// 			'hide_empty' => false,
// 		);
// 		$term_cost = get_terms( $term_args_cost );
// 		$term_ids=array();
// 		if ( ! empty( $term_cost ) ) {
...
// 			}
// 		}
// 		var_dump($term_ids_ids);die;
// 		if ( ! empty( $term_ids ) && is_array( $term_ids ) ) {
// 			foreach ( $term_ids as $k => $term_id ) {
// 				$value   = get_term_meta( $term_id, $key, true );
// 					$new_key = str_replace( 'wps_bfw_', 'wpa_bfw_', $key );
...
// 	// 		'hide_empty' => false,
// 	// 	);
// 	// 	$terms1 = get_terms( $term_args1 );
// 	// 	$arr2=array();
// 	// 	if ( ! empty( $terms1 ) ) {
// 	// 		foreach( $terms1 as $index => $value ) {
// 	// 			array_push( $arr2, $value->term_id );
// 	// 		}
// 	// 	}
// 	// 	$term_args = array(
// 	// 		'taxonomy' => 'wps_booking_service',
...
// 	if ( taxonomy_exists( 'mwb_booking_cost' ) ) {
// 		global $wpdb;
...
//     SET  `taxonomy` =  'wps_booking_random_new' 
//     WHERE  `taxonomy` = 'wps_booking_random'"
// ));
// die;
