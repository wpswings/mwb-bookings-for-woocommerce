...
<p><?php printf( esc_html__( 'Hi %s,', 'mwb-bookings-for-woocommerce' ), esc_html( $order->get_billing_first_name() ) ); ?></p>
<p><?php esc_html_e( 'Your Booking payment is pending, please complete the payment. Here’s a reminder of what you booked:', 'mwb-bookings-for-woocommerce' ); ?></p>
