...
<p><?php printf( esc_html__( 'You’ve received the following order from %s:', 'mwb-wc-bk' ), $order->get_formatted_billing_full_name() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
