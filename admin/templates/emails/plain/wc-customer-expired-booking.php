...
printf( __( 'A subscription belonging to %1$s has been expired. Their subscription\'s details are as follows:', 'mwb-wc-bk' ), $order->get_formatted_billing_full_name() );
