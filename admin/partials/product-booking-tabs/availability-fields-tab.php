 ...
 */
	...
	$this->mwb_booking_setting_fields['booking_start_time']           = isset( $_POST['mwb_booking_start_time'] ) ? sanitize_text_field( wp_unslash( $_POST['mwb_booking_start_time'] ) ) : '';
	$this->mwb_booking_setting_fields['booking_start_time']           = isset( $_POST['mwb_booking_end_time'] ) ? sanitize_text_field( wp_unslash( $_POST['mwb_booking_end_time'] ) ) : '';
...
<div id="mwb_booking_availability_data" class="panel woocommerce_options_panel show_if_mwb_booking">
	...
	<div id="mwb_availability_preferences" class="options_group">
		...
		<p class="form-field">
			...
			<input type="time" name="mwb_booking_start_time" id="mwb_booking_start_time">
		...
		<p class="form-field">
			...
			<input type="time" name="mwb_booking_end_time" id="mwb_booking_end_time">
	...
	<div id="mwb_advance_booking" class="options_group">
		...
		<p class="form-field">
			...
			<?php mwb_booking_help_tip( esc_html__( 'Booking will not be allowed on selected days', 'mwb-wc-bk' ) ); ?>	
		</p>
	</div>
